...
void main() {
  ...
  testWidgets("Finding popMenu in Detail page in reported state(17)", (
    WidgetTester tester,
  ) async {
    final fakeExpenses = [
      Expense(
    ...
    expect(find.text("Submit to Manager"), findsWidgets);
  });

  testWidgets(
    "finding Submit to manager in Detail page in reported state(17)",
