...
void main() {
  ...
  testWidgets("Finding popMenu in Detail page in draft state(17)", (
    WidgetTester tester,
  ) async {
    final fakeExpenses = [
      Expense(
  ...
  testWidgets("finding create report in the detail page in draft state (17)", (
    WidgetTester tester,
  ) async {
    final fakeExpenses = [
      Expense(
    ...
    final detailButton = find.byKey(Key('details_button'));
