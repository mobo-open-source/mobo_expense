...
class CustomSnackBar {
  ...
  static _SnackBarColor _getColorsForType(SnackBarType type, bool isDark) {
    switch (type) {
      case SnackBarType.info:
        return _SnackBarColor(
