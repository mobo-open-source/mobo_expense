  ...
  late final List<Map<String, String>> onboardingData = [
    {
      ...
      'description':
          'Easily record, monitor, and manage your daily business expenses with complete control and accuracy.',
    },
    {
      'image': _getImagePath('02'),
      'title': 'Organize all your expenses',
      'description':
          'Access and organize every expense in one place so nothing is missed and everything stays well structured.',
    },
    {
      'image': _getImagePath('03'),
      'title': 'Expense insights',
      'description':
          'Analyze spending patterns and track expense trends to maintain better budget control.',
    },
  ];
